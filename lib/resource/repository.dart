...
class Repository {
  ...
  Future<List<Sentence>> getSentencesByKanji(String kanjiStr) =>
      DBProvider.db.getSentencesByKanji(kanjiStr);

  Stream<Sentence> getSentencesByKanjiStream(String kanjiStr) =>
      DBProvider.db.getSentencesByKanjiStream(kanjiStr);
  ...
  Future deleteKanjiListFromCloud(KanjiList kanjiList) =>
